    ...
    return(
        <>
            <section id="skills">
                ...
                <h1 className="section-title skills-title">Specialized In</h1>
                ...
                <div className="grid-3">
                    ...
                    <div className="skill">
                        ...
                        <h4>Back End</h4>
                        <p>
                            Frameworks and languages like Node.js, Express, Django, or Ruby on Rails.
                        </p>
                    </div>
                    ...
                    <div className="skill">
                        ...
                        <p>
                            Tools used in development, such as Docker, Git, Jenkins, AWS, or CI/CD solutions.
                        </p>
                    </div>
                    </div>
                </div>
